...
<template>
  <section class="page-stack" v-loading="loading">
    <header class="page-heading"><div><p class="eyebrow">Platform / Live overview</p><h1>网关仪表盘</h1><p>读取当前网关、额度与账单事实数据；不展示业务 Prompt 或真实 Provider 凭据。</p></div><el-button @click="load">刷新数据</el-button></header>
